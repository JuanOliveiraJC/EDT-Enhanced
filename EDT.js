...
EDTEnhancedModel = require('app/base/Class').extend({
    ...
    init: function(){
        ...
        a.append('<div class="chat-update"><span style="color:#0000FF">Entre para o nosso</span> <a span="color:#0000FF" href="http://j.mp/14THjE0" target="_blank">grupo</a></div>');
        a.append('<div class="chat-update"><span style="color:#0000FF">Curta nossa</span> <a span="color:#0000FF" href="http://j.mp/13KWqPd" target="_blank">página</a></div>');
