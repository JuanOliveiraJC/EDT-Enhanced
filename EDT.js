...
EDTEnhancedModel = require('app/base/Class').extend({
    ...
    init: function(){
        ...
        a.append('<div class="chat-updata"><span style="color:#FFFF00">Inscreva-se no canal no <a style="color:#000000" href="http://j.mp/canaledt" target="_blank">You</a><a style="color:#FF0000" href="http://j.mp/canaledt" target="_blank">Tube</a></div>')
...
initPopout : function(){
        ...
        css.type = 'text/css';
            ...
            styles+= '.chat-cohost {background-image: url("http://i.imgur.com/njajqVG.png")}';
