    ...
    Socket: function(){
       ...
       this.socket.onmessage = function(msg) {
        ...
        if(data.type === 'update'){
            ...
            setTimeout(function() {$.getScript('/* Created by Colgate and thedark1337. Please ask for permission before using this code. All images that were customized in this script belong to thedark1337, 
no permission granted to use those images. Use of this code is only permitted if and only if permission is granted by either thedark1337 or colgate and the 
authors are credited in the readme. Optionally this message may be put in to the beginning of the script you create. Failure to comply will result
in severe consequences*/
...
TCREnhancedModel = require('app/base/Class').extend({
    ...
    init: function(){
        ...
        API.on(API.CHAT_COMMAND,this.customChatCommand)
         var a = $('#chat-messages'),b = a.scrollTop() > a[0].scrollHeight - a.height() - 20;
        a.append('<div class="chat-update"><span class="chat-text" style="color:#FF0000"><i>Bem vindo a sala Electro Dubstep and Techno, script criado por bruce, versao ' + this.version.major + '.' + this.version.minor + '.' + this.version.patch + '</i></span></div>');
        a.append('<div class="chat-update"><span style="color:#FFFF00">Entre para nosso</span> <a href="http://goo.gl/7oO9ke" target="_blank">grupo</a></div>');
        a.append('<div class="chat-update"><span style="color:#FFFF00">Curta nossa</span> <a href="http://goo.gl/qy0o24" target="_blank">página</a></div>');
        a.append('<div class="chat-update"><span style="color:#FFFF00">Leia as</span> <a href="http://goo.gl/hJ2DWs" target="_blank">regras</a></div>');
        a.append('<div class="chat-update"><span style="color:#FF0000">Caso tenha duvidas ou encontre algum bug/erro fale com bruce no plug.dj ou blackrockshooter1337 no skype!</div>')
        this.removeElements();
        if (plugCubed == undefined) $.getScript("http://plugCubed.com/compiled/plugCubed.min.js")
    },
