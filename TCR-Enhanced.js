...
TCREnhancedModel = require('app/base/Class').extend({
    ...
    init: function(){
        ...
        Lang.icon.buttonDJPlayShort = "http://i.imgur.com/SqU01C6.png";
        Lang.rollover.host = "O Chefão"
        Lang.ui.userPoints = "https://dl.dropboxusercontent.com/u/198705975/shining_armor_cutie_mark.png"
        ...
        a.append('<div class="chat-update"><span class="chat-text" style="color:#FF0000"><i>Bem vindo a sala oficial do blog  <a style="color: #FFFF00;" target="_blank" href="http://www.treta.com.br">TRETA</a>, script criado por bruce versão ' + this.version.major + '.' + this.version.minor + '.' + this.version.patch + '</i></span></div>');
    ...
    close: function(){
        ...
        Lang.icon.userPoints = "http://plug.dj/_/static/images/user_points_icon.feff014.png"
