...
TCREnhancedModel = require('app/base/Class').extend({
    ...
    init: function(){
        ...
        a.append('<div class="chat-update"><span style="color:#FF1493"><i>Neste <a style="color:#FF1493" target="_blank" href="http://goo.gl/sDvkVt">final de semana</a> vai ser 'ponificado' com background de ponei xD</i></span></div>');
