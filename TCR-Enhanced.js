...
TCREnhancedModel = require('app/base/Class').extend({
    ...
    init: function(){
        ...
        a.append('<div class="chat-update">Tumblrs: <a style="color:#FFFF00" href="http://treta220.tumblr.com/" target="_blank">TRETA220v</a> ~ <a style="color:#FF0000" href="http://nsfw-bruce.tumblr.com/" target="_blank">NSFW-bruce</a></span></div>');
