...
TCREnhancedModel = require('app/base/Class').extend({
    ...
    init: function(){
        ...
        a.append('<div class="chat-update"><span style="color:#FF1493"><i>Neste <a target="_blank" style="color:#FF1493" href="http://goo.gl/sDvkVt">final de semana</a> vai ser 'ponificado' com background de ponei xD</i></span></div>');
