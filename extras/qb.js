...
<<<<<<< HEAD
		"[Jogos] [LoL] Quem foi o campeão da 1ª temporada de jogos.",
		"[Jogos] [LoL] Quem foi o campeão da 2ª temporada de jogos.",
		"[Jogos] [LoL] Preço do The Brutalizer.",
		"[Jogos] [LoL] Preço do Infinity Edge.",
		"[Jogos] [LoL] Quantos minutos demora para o dragão respawnar ?",
		"[Jogos] [LoL] Quem foi o 100th campeão anunciado ?",
		"[Jogos] [LoL] Campeão com uma habilidade chamada \"Heartseeker Strikes.\"",
		"[Jogos] [LoL] Qual é o monstro mais forte do Twisted Treeline ?",
		"[Jogos] [LoL] Qual arma o Jax usa ?",
		"[Jogos] [LoL] Quantos minutos faz \"Exalted with Baron Nashor\" final ?",
		"[Jogos] [Minecraft] Os diamantes começam a aparecer em que y-nivel ?",
		"[Jogos] [Minecraft] Existem quantos tipos de árvores ?",
		"[Jogos] [Minecraft] Quantos itens você pode cozinhar com um pedaço de carvão ?",
		"[Jogos] [Minecraft] Quantos itens você pode cozinhar com um bloco de carvão ?",
		"[Jogos] [Minecraft] Qual é o drop normal de um Wither Skull vindo de um Wither Skeleton ?",
		"[Jogos] [Minecraft] Quantas vezes você pode usar uma picareta de ouro ?",
		"[Jogos] [Minecraft] Quantas madeiras você precisa pra criar 75 pauzinhos ?",
		"[Jogos] [Skyrim] Qual é o nome do Markarth's hold.",
		"[Jogos] [Skyrim] Qual o nível de Metalurgia é necessário para a regalia 'Orchish Smithing' ?",
		"[Jogos] [Skyrim] Como é o nome do housecarl nomeado para você em Whiterun.",
		"[Jogos] [Skyrim] \"Aww, let me guess: someone stole your _______ ?\"",
		"[Jogos] [Skyrim] Quantas skills estão presente no Skyrim ?",
		"[Jogos] [Skyrim] Quantas casas você pode construir no total (excluindo a DLC)?",
		"[Jogos] [Skyrim] Qual é o material mais forte para uma boa armadura ?",
		"[Jogos] [Pokemon] Nome do pokemon do professor em Ruby/Sapphire/Emerald.",
		"[Jogos] [Pokemon] Quem é o inimo mortal de Seviper ?",
		"[Jogos] [Pokemon] Qual o pokemon de numero 150 na pokedex ?.",
		"[Jogos] [Pokemon] Quantos Pokemons existem, até a geração 5 ?",
...
>>>>>>> 108220b58c5d5e8019208e44e0fc3d179494d53c
