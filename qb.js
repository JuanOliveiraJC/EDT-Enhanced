...
var quizBotModel = require('app/base/Class').extend({
	...
	questions: [
		...
		"[Music] Who is the #1 DJ in the world in 2012 according to DJMAG?",
		"[Music] How many songs are on the Monstercat Launch Week Album?",
		"[Gaming] [LoL] Season 1 championship winners.",
		"[Gaming] [LoL] Season 2 championship winners.",
		"[Gaming] [LoL] Price of The Brutalizer.",
		"[Gaming] [LoL] Price of the Infinity Edge.",
		"[Gaming] [LoL] How many minutes does it take for the Dragon to respawn?",
		...
		"[plug.dj] What is The plug.dj owner's name.",
